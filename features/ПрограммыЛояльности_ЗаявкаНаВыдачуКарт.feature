...
Сценарий: Проверка создания документа "Заявка на выдачу карт" (Позитивный)
	* Заполнение шапки документа
		И В командном интерфейсе я выбираю "Программы лояльности" "Заявка на выдачу карт"
		Тогда открылось окно "Заявка на выдачу карт"
		...
		И из выпадающего списка с именем 'Статус' я выбираю по строке "Новый"
		И из выпадающего списка с именем 'ВидЛояльности' я выбираю по строке "Скидочная"
		И я перехожу к следующему реквизиту
	* Запись и проведение
		И я нажимаю на кнопку с именем 'ФормаЗаписать'
		И я нажимаю на кнопку с именем 'ФормаПровестиИЗакрыть'

Сценарий: Проверка создания документа "Заявка на выдачу карт" (Негативный)
	* Заполнение шапки документа
		И В командном интерфейсе я выбираю "Программы лояльности" "Заявка на выдачу карт"
		Тогда открылось окно "Заявка на выдачу карт"
		И я нажимаю на кнопку с именем 'ФормаСоздать'
